...
//    private TextField id = new TextField("id");
    ...
    public ParkingZoneForm(Consumer<ParkingZoneDto> onSaveHandler, Consumer<ParkingZoneDto> deleteHandler) {
    ...
    public void setParkingNames(List<ParkingDto> parkings){
        this.parkingNames.setItems(parkings);
        this.parkingNames.setItemLabelGenerator(ParkingDto::getName);
    }
